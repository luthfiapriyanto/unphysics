...
public class elastis extends ActionBarActivity {
    MediaPlayer player;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.buttonke1).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(elastis.this, elastis1.class));
                player= MediaPlayer.create(elastis.this, R.drawable.click);
                player.start();
            }
        });
