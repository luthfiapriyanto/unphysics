...
public class MenuHooke2 extends ActionBarActivity {
    MediaPlayer player;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menuhooke2);
        ...
        findViewById(R.id.tombolketegangan).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MenuHooke2.this, hooke2.class));
                player= MediaPlayer.create(MenuHooke2.this, R.drawable.click);
                player.start();
            }
        });
    }
