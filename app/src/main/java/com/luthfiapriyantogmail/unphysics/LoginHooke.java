...
public class LoginHooke extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.loginhooke);
    }

    public void submit(View view){
        String enteredPassword = ((EditText) findViewById(R.id.PasswordTegangan)).getText().toString();
        if(enteredPassword.matches("thomas young"))
        {
            Intent intent = new Intent(LoginHooke.this, SoalHooke1.class);
