...
public class MenuHooke1 extends ActionBarActivity {
    MediaPlayer player;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menuhooke1);
        ...
        findViewById(R.id.buttonke1).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MenuHooke1.this, videohooke.class));
                player= MediaPlayer.create(MenuHooke1.this, R.drawable.click);
                player.start();
            }
        });
