...
public class MenuElastis3 extends ActionBarActivity {
    MediaPlayer player;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menuelastis3);
        ...
        findViewById(R.id.buttonkefinal).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MenuElastis3.this, LoginElastis.class));
                player= MediaPlayer.create(MenuElastis3.this, R.drawable.click);
                player.start();
            }
        });
