...
public class MenuPegas3 extends ActionBarActivity {
    MediaPlayer player;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menupegas3);
        ...
        findViewById(R.id.buttonkefinal).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MenuPegas3.this, LoginPegas.class));
                player= MediaPlayer.create(MenuPegas3.this, R.drawable.click);
                player.start();
            }
        });
